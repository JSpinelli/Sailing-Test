	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_FlappingMap = IN.ase_texcoord7.xy * _FlappingMap_ST.xy + _FlappingMap_ST.zw;
				float temp_output_98_0 = ( tex2D( _FlappingMap, uv_FlappingMap ).r * IN.ase_texcoord8.xyz.y );
				float mulTime88 = _TimeParameters.x * _TimeScale;
				float temp_output_90_0 = ( ( temp_output_98_0 * _Wigliness ) + mulTime88 );
				float3 appendResult95 = (float3(( temp_output_98_0 * ( sin( temp_output_90_0 ) * _Magnitude ) * sin( ( _Offset + temp_output_90_0 ) ) ) , 0.0 , 0.0));
				float3 offset99 = appendResult95;
				float3 normals3 = ( UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f ) + offset99 );
				...
				float Occlusion = ( ( lighting73 + rim75 ) + Spec78 ).r;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
315;81;1209;635;-950.887;143.7194;1.3;True;True
...
WireConnection;108;5;82;0
WireConnection;108;8;100;0
ASEEND*/
//CHKSM=A44E383F64C88FDB01026392C1A0FCAF9B1FD992