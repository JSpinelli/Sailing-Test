	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_FlappingMap = v.texcoord.xy * _FlappingMap_ST.xy + _FlappingMap_ST.zw;
				float temp_output_98_0 = ( tex2Dlod( _FlappingMap, float4( uv_FlappingMap, 0, 0.0) ).r * v.vertex.xyz.y );
				float mulTime88 = _TimeParameters.x * _TimeScale;
						 ...
						 ) : SV_Target
			{
				...
				float3 normals3 = tex2DNode2;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal12 = normals3;
				...
				float3 tanNormal84 = normals3;
				float3 bakedGI84 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal84), dot(tanToWorld1,tanNormal84), dot(tanToWorld2,tanNormal84)));
				float4 lighting73 = ( shadow59 * ( _MainLightColor * float4( ( ase_lightAtten + bakedGI84 ) , 0.0 ) ) );
				float3 tanNormal7 = normals3;
				...
				float4 rim75 = ( saturate( ( pow( ( 1.0 - saturate( ( _RimOffset + normalViewdir13 ) ) ) , _RimPower ) * ( normalLightDir21 * 0.0 ) ) ) * ( _MainLightColor * _RimTint ) );
				float3 tanNormal34 = normals3;
				float3 worldNormal34 = float3(dot(tanToWorld0,tanNormal34), dot(tanToWorld1,tanNormal34), dot(tanToWorld2,tanNormal34));
				float dotResult45 = dot( ( WorldViewDirection + _MainLightPosition.xyz ) , worldNormal34 );
				...
				float4 lerpResult55 = lerp( _SpecularColor , _MainLightColor , _SpecColorLightContribution);
				float4 Spec78 = ( float4( 0,0,0,0 ) * ( ( smoothstepResult61 * ( tex2D( _SpecMap, uv_SpecMap ) * lerpResult55 ) ) * _SpecIntensity ) );
				
				float3 Albedo = albedo35.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( lighting73 + rim75 ) + Spec78 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 uv_FlappingMap = v.ase_texcoord.xy * _FlappingMap_ST.xy + _FlappingMap_ST.zw;
				float temp_output_98_0 = ( tex2Dlod( _FlappingMap, float4( uv_FlappingMap, 0, 0.0) ).r * v.vertex.xyz.y );
				float mulTime88 = _TimeParameters.x * _TimeScale;
				float temp_output_90_0 = ( ( temp_output_98_0 * _Wigliness ) + mulTime88 );
				float3 appendResult95 = (float3(( temp_output_98_0 * ( sin( temp_output_90_0 ) * _Magnitude ) * sin( ( _Offset + temp_output_90_0 ) ) ) , 0.0 , 0.0));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult11 = dot( worldNormal7 , ase_worldViewDir );
				float normalViewdir13 = dotResult11;
				float4 rim75 = ( saturate( ( pow( ( 1.0 - saturate( ( _RimOffset + normalViewdir13 ) ) ) , _RimPower ) * ( normalLightDir21 * 0.0 ) ) ) * ( _MainLightColor * _RimTint ) );
				float3 tanNormal34 = normals3;
				float3 worldNormal34 = float3(dot(tanToWorld0,tanNormal34), dot(tanToWorld1,tanNormal34), dot(tanToWorld2,tanNormal34));
				float dotResult45 = dot( ( ase_worldViewDir + _MainLightPosition.xyz ) , worldNormal34 );
				float smoothstepResult61 = smoothstep( 1.1 , 1.4 , pow( dotResult45 , _Gloss ));
...
/*ASEBEGIN
Version=18900
391;73;1182;575;2983.764;414.1801;2.805825;True;True
...
Node;AmplifyShaderEditor.ColorNode;17;-1481.372,-122.4796;Inherit;False;Property;_Tint;Tint;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7245173,0.735849,0.3505696,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-1511.181,-394.2596;Inherit;False;Property;_RampScale;Ramp Scale;4;0;Create;True;0;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;47;-1113.585,-481.8793;Inherit;True;Property;_ToonRamp;Toon Ramp;0;0;Create;True;0;0;0;False;0;False;-1;None;f5a194e417179914898568321e484ff2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;37;-674.5052,-1129.73;Inherit;False;Property;_RimPower;Rim Power;9;0;Create;True;0;0;0;False;0;False;0;0.037;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;1164.305,1256.564;Inherit;False;Property;_TimeScale;Time Scale;6;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;1171.006,1174.665;Inherit;False;Property;_Wigliness;Wigliness;1;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;1518.398,1010.226;Inherit;False;Property;_Offset;Offset;17;0;Create;True;0;0;0;False;0;False;0;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;1580.204,1254.565;Inherit;False;Property;_Magnitude;Magnitude;3;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;99;2311.936,1195.596;Inherit;False;offset;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;108;2;82;0
WireConnection;108;8;100;0
ASEEND*/
//CHKSM=52F1139AEE3C06C3953B3E84BCAE7B9D6F453846